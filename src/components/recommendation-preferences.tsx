...
export default function RecommendationPreferences() {
  ...
  return <section className="recommendation-preferences" aria-labelledby="preferences-heading">
    <div><span>Recommendation profile</span><h2 id="preferences-heading">Tell CoachConnect what fits</h2><p>CoachConnect uses these saved preferences to rank matching profiles at the top of the catalog. Your email, password and payment fields are never used for ranking.</p></div>
    <form onSubmit={save}>
